...
buttAdd = Button(root, text="+",bg="Black",fg ="Green",padx=40,pady=20, command=button_add)
buttClear = Button(root, text="Clear",bg="Black",fg ="Green",padx=77,pady=20, command=button_clear)
buttEqual = Button(root, text="=",bg="Black",fg ="Green",padx=86,pady=20, command=button_equal)
